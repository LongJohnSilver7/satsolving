...
if __name__ == "__main__":
    ...
    print(Decisionheuristics.jersolow_wang_method(cnf.clauses, cnf.propositions))
    print(Decisionheuristics.dynamic_largest_individual_sum(cnf.clauses, cnf.propositions))
